...
One can make a justification for a weighted model, here, since sample sizes
vary significantly. A weighted model brings the regression line closer to Sebago because of its large sample size.  Sebago no longer appears as an outlier,
although it still has the highest leverage of any lake.
